...
using SignalFunc = void(MDEventType, cv::Point ,cv::Point );
...
public:
	...
	MotionDetectorWithInterestRects(InterestRects rects, int in_detection_period = 1000);
...
private:
	const InterestRects interest_rects_;
